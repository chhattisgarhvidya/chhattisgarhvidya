---
title: Construye un juego espacial Parte II: Dibuja héroes y monstruos en el lienzo
description: Imagen de [MDN](https://developer.mozilla.org/docs/Web/API/Canvas_API/Tutorial/Drawing_shapes)
