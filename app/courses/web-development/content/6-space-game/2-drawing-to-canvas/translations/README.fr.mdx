---
title: Construisez un jeu spatial, partie 2 : dessinez des héros et des monstres sur le canevas
description: Image de [MDN](https://developer.mozilla.org/docs/Web/API/Canvas_API/Tutorial/Drawing_shapes)
