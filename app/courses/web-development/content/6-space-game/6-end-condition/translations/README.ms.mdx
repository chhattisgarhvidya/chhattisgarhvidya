---
title: Bina Permainan Angkasa Bahagian 6: Tamat dan Mulakan Semula
description: tip: untuk mengelakkan amaran dalam Visual Studio Code, edit fungsi `window.onload` untuk memanggil `gameLoopId` sebagaimana adanya (tanpa `let`), dan nyatakan gameLoopId di bahagian atas fail, secara bebas: `let gameLoopId;`
lastUpdated: 2024-12-21T06:11:55.234Z
---
