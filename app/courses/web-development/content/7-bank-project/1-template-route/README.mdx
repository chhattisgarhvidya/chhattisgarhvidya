---
title: Build a Banking App Part 1: HTML Templates and Routes in a Web App
description: Tip: since the content of this element will be replaced, we can put in a loading message or indicator that will be shown while the app is loading.
lastUpdated: 2024-12-21T06:11:55.322Z
---
