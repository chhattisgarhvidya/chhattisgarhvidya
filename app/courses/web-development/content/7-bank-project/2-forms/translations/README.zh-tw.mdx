---
title: 建立銀行網頁應用程式 Part 2：登入與註冊表單
description: 花點時間看看 [`<input>` 種類](https://developer.mozilla.org/docs/Web/HTML/Element/input)的清單與[其他表單控制](https://developer.mozilla.org/docs/Learn/Forms/Other_form_controls)，讓你在建立使用者介面時，有全部供你使用的原生 UI 元素可以參考。
lastUpdated: 2024-12-21T06:11:55.401Z
---
