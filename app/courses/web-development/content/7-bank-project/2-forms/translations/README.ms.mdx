---
title: Bina Aplikasi Perbankan Bahagian 2: Bina Log Masuk dan Borang Pendaftaran
description: Lihat keseluruhan senarai [`<input>` types](https://developer.mozilla.org/docs/Web/HTML/Element/input) dan [kawalan bentuk lain](https://developer.mozilla.org/docs/Learn/Forms/Other_form_controls) untuk mendapatkan idea tentang semua elemen UI asli yang boleh anda gunakan semasa membina UI anda.
lastUpdated: 2024-12-21T06:11:55.398Z
---
