---
title: Build a Banking App Part 3: Methods of Fetching and Using Data
description: While all modern browsers support the `Fetch API`, if you want your web application to work on legacy or old browsers it's always a good idea to check the [compatibility table on caniuse.com](https://caniuse.com/fetch) first.
lastUpdated: 2024-12-21T06:11:55.419Z
---
