---
title: Créer une application bancaire Partie 3: Méthodes de récupération et d'utilisation des données
description: Bien que tous les navigateurs modernes prennent en charge l’API Fetch, si vous souhaitez que votre application Web fonctionne sur des navigateurs hérités ou anciens, il est toujours judicieux de vérifier d’abord le [tableau de compatibilité sur caniuse.com](https://caniuse.com/fetch).
lastUpdated: 2024-12-21T06:11:55.423Z
---
