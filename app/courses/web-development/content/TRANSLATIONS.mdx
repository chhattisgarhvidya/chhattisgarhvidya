---
title: Translated lessons
description: Note, please do not translate any code in the code sample files; the only things to translate are README, assignments, and quizzes. Thanks!
