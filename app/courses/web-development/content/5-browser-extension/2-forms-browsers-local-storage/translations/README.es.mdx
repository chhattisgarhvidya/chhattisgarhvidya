---
title: Proyecto de extensión del navegador, parte 2: llamar a una API, usar almacenamiento local
description: Nota: la extensión de su navegador tiene su propio almacenamiento local; la ventana principal del navegador es una instancia diferente y se comporta por separado.
