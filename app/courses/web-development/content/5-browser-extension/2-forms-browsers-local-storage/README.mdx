---
title: Browser Extension Project Part 2: Call an API, use Local Storage
description: Note - your browser extension has its own local storage; the main browser window is a different instance and behaves separately.
lastUpdated: 2024-12-21T06:11:54.822Z
---
