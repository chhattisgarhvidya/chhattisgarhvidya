            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
              ...
              <div className="mt-20 grid grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-3">
                ...
                <div className="bg-gray-100 dark:bg-gray-700 overflow-hidden shadow rounded-lg">
                  <div className="px-4 py-5 sm:p-6">
                    <p className="text-base text-gray-500 dark:text-gray-300">
                      {"The flexibility of EduSites platform allowed me to balance my studies with my full-time job. I couldn't be happier with the results!"}
                    </p>
                    <div className="mt-4">
          ...
          <div className="max-w-7xl mx-auto py-12 px-4 sm:px-6 md:flex md:items-center md:justify-between lg:px-8">
            <div className="flex justify-center space-x-6 md:order-2">
              <a href="#" className="text-gray-400 hover:text-gray-500">
                ...
                <svg className="h-6 w-6" fill="currentColor"><svg className="h-6 w-6" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
